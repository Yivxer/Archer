...
_COMMANDS = [
    ...
    ("/project",              "列出所有项目"),
    ("/project new ",         "创建项目：/project new <名称> [描述]"),
    ("/project use ",         "切换活跃项目：/project use <ID|名>"),
    ("/project log ",         "记录项目事件：/project log <ID|名> <内容>"),
    ("/project status ",      "查看项目详情：/project status <ID|名>"),
    ("/project archive ",     "归档项目：/project archive <ID|名>"),
    ("/soul",                 "查看 SOUL 演化提议"),
